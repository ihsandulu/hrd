                                        ...
                                        <div class="table-responsive m-t-40">
                                            <table id="example23" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                                ...
                                                <tbody>
                                                    ...
                                                    $build = $this->db->table("lain")
                                                        ->join("user", "user.user_id=lain.user_id", "left")
                                                    ...
                                                    $build->where("lain_date >=", $dari);
                                                    $build->where("lain_date <=", $ke);
                                                    ...
                                                    foreach ($usr->getResult() as $usr) { ?>
                                                        <tr>
                                                                ...
                                                                <td style="padding-left:0px; padding-right:0px;">
                                                                    ...
                                                                    if (
                                                                        ...
                                                                        <!-- <form method="post" class="btn-action" style="">
                                                                            ...
                                                                            <input type="hidden" name="lain_id" value="<?= $usr->lain_id; ?>" />
                                                                        </form> -->
                                                            ...
                                                            <td><?= $usr->user_nik; ?></td>
                                                            <td><?= $usr->user_nama; ?></td>
                                                            <td><?= $tipe[$usr->lain_type]; ?></td>
                                                            <td><?= $usr->lain_date; ?></td>
                                                            <td><?= $usr->lain_nominal; ?></td>
                                                            <td><?= $usr->lain_keterangan; ?></td>
                                                        </tr>
                                                    <?php } ?>
                                                </tbody>
                                            </table>
                            ...
                            <div id="collapseTwo" class="collapse <?= $panel2['collapseClass'] ?>" aria-labelledby="headingTwo" data-parent="#faqAccordion">
                                <div class="card-body">
                                    ...
                                    <div class="alert alert-info">
                                        <form method="post" action="<?= base_url("lain"); ?>">
                                            <div class="row">
                                                <?php
                                    ...
                                    <div class="">
                                        <div class="row">
                                            <div class="col-3 row mb-2">
                                                ...
                                                <div class="col-9">
                                                    <input type="date" class="form-control" placeholder="Tanggal" name="lain_date" value="<?=date("Y-m-d");?>">
                                                </div>
                                            </div>
                                            <div class="col-2 row mb-2">
                                                <div class="col-12">
                                                    <input type="number" class="form-control" placeholder="Nominal" name="lain_nominal">
                                                </div>
                                            </div>
                                            <div class="col-2 row mb-2">
                                                <div class="col-12">
                                                    <select class="form-control" name="lain_type">
                                                        <option value="0">Pilih In/Out</option>
                                            ...
                                            <div class="col-6 row mb-2">
                                                ...
                                                <div class="col-11">
                                                    <input type="text" class="form-control" placeholder="" name="lain_keterangan">
                                                </div>
                                            </div>
