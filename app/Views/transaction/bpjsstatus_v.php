                                        ...
                                        <div class="table-responsive m-t-1">
                                            <table id="example23" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                                ...
                                                <tbody>
                                                    ...
                                                    $build = $this->db->table("bpjsstatus")
                                                        ->join("user", "user.user_id=bpjsstatus.user_id", "left")
                                                    ...
                                                    // $build->where("bpjsstatus_date >=", $dari);
                                                    // $build->where("bpjsstatus_date <=", $ke);
                                                            ...
                                                            <?php if (!isset($_GET["report"])) { ?>
                                                                <td style="padding-left:0px; padding-right:0px;">
                                                                    ...
                                                                    if (
                                                                        ...
                                                                        <input type="hidden" name="bpjsstatus_id" value="<?= $usr->bpjsstatus_id; ?>" /> -->
                                                                        </form>
                                                                    <?php } ?>
                                                                    <input class="cpilih0" type="checkbox" id="p<?= $usr->bpjsstatus_id; ?>" name="bpjsstatus_id[<?= $usr->bpjsstatus_id; ?>]" value="<?= $usr->bpjsstatus_id; ?>" />
                                                                </td>
                                                            <?php } ?>
                                                            <!-- <td><?= $no++; ?></td> -->
