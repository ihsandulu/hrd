                    ...
                    <div class="accordion" id="faqAccordion">
                            ...
                            <div class="card-header card-success" id="headingOne">
                                <h2 class="mb-0">
                                    <button class="btn btn-link btn-block text-left text-white bold <?= $panel1['buttonClass'] ?>" type="button" data-toggle="collapse" data-target="#collapseOne" aria-expanded="<?= $panel1['ariaExpanded'] ?>" aria-controls="collapseOne">
                                        <i class="fa fa-arrow-down"></i> History <?= $title; ?>
                                    </button>
                                </h2>
                            </div>
                                            ...
                                            <div class="row">
                                               ...
                                               <!--  <div class="col-3 row mb-2">
                                                ...
                                                <div class="col-12  mb-2 mt-2">
                                                    <button name="histori" type="submit" class="btn btn-block btn-primary">Search</button>
                                                </div>
                                            </div>
                                        </form>
                                    </div>
                                        ...
                                        <div class="table-responsive m-t-1">
                                            <table id="example23" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                                ...
                                                <tbody>
                                                    ...
                                                    // $build->where("kontrak_from >=", $dari);
                                                    // $build->where("kontrak_from <=", $ke);
                                                            ...
                                                            <?php if (!isset($_GET["report"])) { ?>
                                                                <td style="padding-left:0px; padding-right:0px;">
                                                                    ...
                                                                    if (
                                                                        ...
                                                                        <input type="hidden" name="kontrak_id" value="<?= $usr->kontrak_id; ?>" /> -->
                                                                        </form>
                                                                    <?php } ?>
                                                                    <input class="cpilih0" type="checkbox" id="p<?= $usr->kontrak_id; ?>" name="kontrak_id[<?= $usr->kontrak_id; ?>]" value="<?= $usr->kontrak_id; ?>" />
                                                                </td>
                                                            <?php } ?>
                                                            <!-- <td><?= $no++; ?></td> -->
                                                            <td class="text-left"><?= $usr->departemen_name; ?> - <?= $usr->position_name; ?></td>
                                                            <td class="text-left"><?= $usr->user_nama; ?> (<?= $usr->user_nik; ?>) - <?= $usr->kontrak_name; ?></td>
                        ...
                        <div class="card">
                            <div class="card-header card-success" id="headingTwo">
                                <h2 class="mb-0">
                                    <button class="btn btn-link btn-block text-left text-white bold <?= $panel2['buttonClass'] ?>" type="button" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="<?= $panel2['ariaExpanded'] ?>" aria-controls="collapseTwo">
                                        <i class="fa fa-arrow-down"></i> Pilih <?= $title; ?>
                                    </button>
                                </h2>
                            </div>
                            <div id="collapseTwo" class="collapse <?= $panel2['collapseClass'] ?>" aria-labelledby="headingTwo" data-parent="#faqAccordion">
                                <div class="card-body">
                                    <div class="alert alert-info">
                                        <form method="post" action="<?= base_url("kontrak"); ?>">
                                            <div class="row">
                                                <?php
                                ...
                                <form method="post" action="<?= base_url("kontrak"); ?>">
                                    <div class="">
                                        <div class="row">
                                             <div class="col-3 row mb-2">
                                                <div class="col-3">
                                                    <label class="text-dark">Nama Kontrak</label>
                                                </div>
                                                <div class="col-9">
                                                    <input required type="text" class="form-control" placeholder="Nama Kontrak" name="kontrak_name">
                                                </div>
                                            </div>
                                            <div class="col-3 row mb-2">
                                                <div class="col-3">
                                                    <label class="text-dark">Awal Kontrak</label>
                                                </div>
                                                <div class="col-9">
                                                    <input required type="date" class="form-control" placeholder="Awal Kontrak" name="kontrak_from">
                                                </div>
                                            </div>
                                            <div class="col-3 row mb-2">
                                                <div class="col-3">
                                                    <label class="text-dark">Akhir Kontrak</label>
                                                </div>
                                                <div class="col-9">
                                                    <input required type="date" class="form-control" placeholder="Akhir Kontrak" name="kontrak_to">
                                                </div>
                                            </div>
                                            <!-- <div class="col-2 row mb-2">
                                                ...
                                                <div class="col-9">
                                                    <input required type="number" class="form-control" placeholder="" name="kontrak_jam">
                                                </div>
                                            </div> -->
                                                        ...
                                                        <td>
                                                            ...
                                                            if (isset($arkontrak[$usr->user_id])) {
                                                                foreach ($arkontrak[$usr->user_id] as $row) {
                                                                    echo $row["name"] . " : ".$row["from"] . " s.d " . $row["to"] . "<br>";
                                                                }
                                                            }
                                                            ?>
                                                        </td>
