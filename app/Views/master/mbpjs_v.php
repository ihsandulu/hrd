                            ...
                            if (
                                ...
                                <form method="post" class="col-md-2">
                                    <h1 class="page-header col-md-12">
                                        ...
                                        <input type="hidden" name="bpjs_id" />
                                    </h1>
                                </form>
                            <?php } ?>
                        <?php } ?>
                        ...
                        <div class="">
                            ...
                            <form class="form-horizontal" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group ">
                                    <label class="control-label col-sm-2" for="bpjs_name">Nama BPJS:</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control " id="bpjs_name" name="bpjs_name" placeholder="" value="<?= $bpjs_name; ?>">
                                    </div>
                                </div>

                                <div class="form-group ">
                                    <label class="control-label col-sm-2" for="bpjs_pekerja">Prosentase Pekerja (%):</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control " id="bpjs_pekerja" name="bpjs_pekerja" placeholder="" value="<?= $bpjs_pekerja; ?>">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="col-sm-offset-2 col-sm-10">
                                        ...
                                        <a class="btn btn-warning col-md-offset-1 col-md-5" href="<?= base_url("mbpjs"); ?>">Back</a>
                                    </div>
                                </div>
                            </form>
                        </div>
                                                ...
                                                <td style="padding-left:0px; padding-right:0px;">
                                                    ...
                                                    if (
                                                        ...
                                                        <form method="post" class="btn-action" style="">
                                                            ...
                                                            <input type="hidden" name="bpjs_id" value="<?= $usr->bpjs_id; ?>" />
                                                        </form>
                                                    <?php } ?>
